import 'package:fepi_local/widgets/dynamic_table_widget2.dart';
import 'package:flutter/material.dart';
import 'package:flutter/widgets.dart';

class SearchFilterWidget2 extends StatefulWidget {
  final List<Map<String, String>> data;

  const SearchFilterWidget2({Key? key, required this.data}) : super(key: key);

  @override
  _SearchFilterWidgetState createState() => _SearchFilterWidgetState();
}

class _SearchFilterWidgetState extends State<SearchFilterWidget2> {
  String query = '';
              ...
              final filteredData = widget.data
                  .where((item) =>
                      ...
                      (filterStatus == 'Todos' ||
                          item['Estatus'] == filterStatus))
                  .toList();
              return DynamicTableWidget2(data: [filteredData[index]]);
            },
          ),
        ),
      ],
